...
# Ruby gems support.
Puppet::Type.type(:package).provide :puppet_omnibus_gem, :parent => :gem do
  desc "Puppet Omnibus Ruby Gem support. If a URL is passed via `source`, then
  ...
  commands :gemcmd => "/opt/puppet-omnibus/embedded/bin/gem"
end
